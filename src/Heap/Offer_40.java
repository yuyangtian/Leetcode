/*
剑指 Offer 40. 最小的k个数 easy 26 89时间复杂度高
...
因此我们要对数组中所有的数取其相反数，才能使用小根堆维护前 kk 小值。
...
复杂度分析
时间复杂度：O(n\log k)O(nlogk)，其中 nn 是数组 arr 的长度。由于大根堆实时维护前 kk 小值，
所以插入删除都是 O(\log k)O(logk) 的时间复杂度，最坏情况下数组里 nn 个数都会插入，
所以一共需要 O(n\log k)O(nlogk) 的时间复杂度。
...
public class Offer_40 {
    ...
    public static void main(String[] args) {
        ...
        for(int x :test.getLeastNumbers(arr,2)){
